...
<head>
    ...
    <meta property="og:title"
        content="Simão Acessórios - Acessórios para box,corrimão e esquadrias de alumínio em geral | São Bernardo do Campo/SP">
    ...
    <title>Simão Acessórios - Acessórios para box,corrimão e esquadrias de alumínio em geral | São Bernardo do Campo/SP
    </title>
    <?php wp_head(); ?>
</head>
        ...
        <nav class="navbar fixed-top navbar-expand-md navbar-light bg-bg-color1">
            <div class="container">
                <a class="navbar-brand" href="<?php echo get_home_url(); ?>"><img
                        src="<?php echo get_template_directory_uri(); ?>/_cdn/img/logo-header.png" class="img-fluid"
                        alt="Simão Acessórios"></a>
